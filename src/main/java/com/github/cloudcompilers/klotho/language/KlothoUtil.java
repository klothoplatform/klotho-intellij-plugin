...
//
//  /**
//   * Searches the entire project for Klotho language files with instances of the Klotho property
// with the given key.
//   *
...
//      if (klothoFile != null) {
//        KlothoProperty[] properties = PsiTreeUtil.getChildrenOfType(klothoFile,
// KlothoProperty.class);
//        if (properties != null) {
