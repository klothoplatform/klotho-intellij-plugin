...
public class KlothoPlainNumberImpl extends ASTWrapperPsiElement implements KlothoPlainNumber {

  public KlothoPlainNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlothoVisitor visitor) {
    visitor.visitPlainNumber(this);
  }
