...
public class KlothoAnnotationBodyImpl extends ASTWrapperPsiElement implements KlothoAnnotationBody {

  public KlothoAnnotationBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlothoExpr> getExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlothoExpr.class);
  }
