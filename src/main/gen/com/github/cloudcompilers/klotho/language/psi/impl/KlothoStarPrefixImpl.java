...
public class KlothoStarPrefixImpl extends ASTWrapperPsiElement implements KlothoStarPrefix {

  public KlothoStarPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlothoVisitor visitor) {
    visitor.visitStarPrefix(this);
  }
