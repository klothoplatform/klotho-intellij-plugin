...
public class KlothoLineCommentBlockImpl extends ASTWrapperPsiElement implements KlothoLineCommentBlock {

  public KlothoLineCommentBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlothoVisitor visitor) {
    visitor.visitLineCommentBlock(this);
  }
