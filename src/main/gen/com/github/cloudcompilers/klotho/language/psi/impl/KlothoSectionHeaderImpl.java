...
public class KlothoSectionHeaderImpl extends ASTWrapperPsiElement implements KlothoSectionHeader {

  public KlothoSectionHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiElement getHeaderId() {
    return findChildByType(HEADER_ID);
  }
