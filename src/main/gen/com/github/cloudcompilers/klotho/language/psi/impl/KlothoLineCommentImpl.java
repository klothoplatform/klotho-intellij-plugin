...
public class KlothoLineCommentImpl extends ASTWrapperPsiElement implements KlothoLineComment {

  public KlothoLineCommentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KlothoAnnotationExpr getAnnotationExpr() {
    return findNotNullChildByClass(KlothoAnnotationExpr.class);
  }
