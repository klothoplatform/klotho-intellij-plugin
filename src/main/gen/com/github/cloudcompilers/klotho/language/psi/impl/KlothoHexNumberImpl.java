...
public class KlothoHexNumberImpl extends ASTWrapperPsiElement implements KlothoHexNumber {

  public KlothoHexNumberImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiElement getHexDig() {
    return findChildByType(HEX_DIG);
  }
