...
public class KlothoOctNumberImpl extends ASTWrapperPsiElement implements KlothoOctNumber {

  public KlothoOctNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlothoVisitor visitor) {
    visitor.visitOctNumber(this);
  }
  ...
  @Override
  @Nullable
  public PsiElement getDig07() {
    return findChildByType(DIG0_7);
  }
